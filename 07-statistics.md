...
>> P(ID twin | male twins) = P(male twins | ID twins) x P(ID twins) / P(male twins)
>> P(ID twin | male twins) = (1/2)(1/300) / [(1/2)(1/300) + (1/4)(1/125)]
>> P(ID twin | male twins) = 0.45
...
Bayesian statistics rely on probabilities and prior likelihoods based on fixed data. Frequentist statistics follow set rules according to fixed parameters that describe infinite samples of data; the frequencies are constant even if sampling is repeated. Bayesian statistics allow parameters to be updated as conditions change or further evidence is discovered.
